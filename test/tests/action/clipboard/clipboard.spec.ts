...
test('The button should copy/paste from/to itself on click.', async ({ mount, page, context, browserName }) => {
...
test('The button should copy/paste from/to the target selector on click', async ({ mount, page, context, browserName }) => {
...
test('The button should copy/paste from/to the target element on click', async ({ mount, page, context, browserName }) => {
    if (!setPermissions(browserName, context)) return;
    await mount(Component);
    clearClipboard(page);
